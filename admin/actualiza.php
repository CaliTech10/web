...
$sql="UPDATE productos SET nombre=?,descripcion=?,precio=?,descuento=?,id_categoria=?,activo=?  
WHERE id=?";


$stm=$con->prepare($sql);
if($stm->execute([$nombre,$descripcion,$precio,$descuento,$categoria,$activo,$id])){
